...
class AlphaPulseWindow(QMainWindow):
    ...
    def _control_panel(self) -> QWidget:
        ...
        strat_card = QLabel(
            ...
            f"Conviction-Power Kelly 사이징 (cubic 가중).</span><br><br>"
            ...
            f"<b>amp = conf<sup>{sp.confidence_exponent:.0f}</sup></b> (cubic)<br>"
            f"&nbsp;&nbsp;&nbsp;<span style='color:{SUBTEXT}'>약신호: 0.02% 손실 / 강신호: 5%</span><br>"
