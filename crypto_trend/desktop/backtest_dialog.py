...
class BacktestDialog(QDialog):
    ...
    def _build_form_panel(self) -> QWidget:
        ...
        strat_card = QLabel(
            ...
            f"<b>v2.3 스크리너 triage</b><br>"
            f"&nbsp;&nbsp;z_alpha = 0.05, top_n = 30, min_horizons_agree = 1 "
            f"<span style='color:{SUBTEXT}'>(같은 방향 필터를 두 단에 두는 "
            f"redundancy 제거 — 전략 단 TSM 다수결이 진짜 게이트)</span><br>"
